...
conn = pymysql.connect(host='127.0.0.1',user='icore',password='_M_yster_Y_36',db='weather')

username = 'na_hadjiosif'
password = '38moF1J0lH'

coordList = [(35.112657,33.319656),
           (35.130608,33.370146),
           (35.157861,33.341800)] #Create a list of 3 locations
i = 0 #will need it from row 16 onwards
...
for i in [0,1,2]: #Create a loop to request the 3 locations one at a time
    ...
    enddate = dt.datetime(year=2023, month=1, day=31, hour=21)
...
def latestForecast():
    with conn.cursor() as cur:
        ...
        queryResult = cur.fetchall() #fetch all the data from the query
